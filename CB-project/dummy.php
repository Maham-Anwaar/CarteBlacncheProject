           ...
           $sev = "1";
            ...
            $insertQuery = "insert into patients(pname, diagnosis, casetype) values('$n', '$d', '$sev')";
             $result = mysqli_query($link , $insertQuery);
                ...
                $get = "select pID from  patients where pname= '$n'";
                ...
                $r = $row["pID"];
                $insertQuery2 = "insert into appointments(apDate, d_ID, p_ID) values('$apD', '$x', '$r')";
    ...
    <div class="modal-dialog">
      ...
      <div class="modal-content">
       ...
       <div class="btn-group" role="group" aria-label="Basic example">
          <button type="button" class="btn btn-secondary"   id="1" onclick="change(this.id)">Mild</button>
          <button type="button" class="btn btn-secondary"  id="2" onclick="change(this.id)">Moderate</button>
          <button type="button" class="btn btn-secondary"  id="3" onclick="change(this.id)">Severe</button>
       </div>
                      ...
                      if($count_pro==0)
                      {
                          ...
                          while ($row_pro = mysqli_fetch_array($run_pro)) {
                              ...
                              if($d_id ==  $_SESSION['userinfo']['dID'] )
                              {
                                ...
                                $query = "SELECT * from patients where pID = '".$p_id."'";
                              ...
                              echo "<th style = ".'color:black;font-family: monospace;'." scope=".'row'." width='200' height='80'>$appD </th>";
                               ...
                               echo "<th> <a href=".'trash.php?id='.$a_id.''.">";
